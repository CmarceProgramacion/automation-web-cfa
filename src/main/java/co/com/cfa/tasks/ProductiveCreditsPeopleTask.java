...
public class ProductiveCreditsPeopleTask implements Task {
    private String product;

    public ProductiveCreditsPeopleTask(String product) {
        this.product = product;
    }

    public static Performable whitData(String product) {
        return Tasks.instrumented(ProductiveCreditsPeopleTask.class, product);
    }
