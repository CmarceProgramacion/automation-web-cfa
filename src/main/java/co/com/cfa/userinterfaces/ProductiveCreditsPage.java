...
public class ProductiveCreditsPage extends PageObject {
    ...
    public static Target OPT_PRODUCTIVE_CREDIT_SEE_RATES_BTN = Target.the("  ").locatedBy("//span[@class='elementor-button-content-wrapper']//child::span[contains(., 'VER TASAS Y TARIFAS')]");
