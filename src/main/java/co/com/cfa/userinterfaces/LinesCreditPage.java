...
public class LinesCreditPage extends PageObject {
    ...
    public static Target OPT_SAVINGS_ACCOUNTS_COMPANY_BTN = Target.the("  ").locatedBy("//a[contains(@href,'cuentas-de-ahorro-empresariales')]//child::span[@class='elementor-button-text']");
}
